...
const CreateValue = () => {
  ...
  return (
    <section className="flex flex-col gap-4 md:gap-14 px-4 md:px-10 py-6 md:pt-16 items-center font-TT-Commons ">
      <div className="relative flex flex-col gap-4 md:gap-6 items-center justify-center w-full font-TT-Commons px-2 md:px-[25rem]">
        ...
        <div className="text-center">
          <h1 className="text-[#071a0a] text-3xl md:text-5xl">
            <span className="text-[#248232] justify-center ">Creating value</span> for our
