        ...
        <section >
            ...
            <div className="font-TT-Commons grid grid-rows-1 md:grid-cols-2 gap-4 md:gap-8 relative px-[0.625rem] md:px-[1.5625rem] lg:px-[3.125rem]">
                ...
                <div className="content flex flex-col gap-[2.5rem] text-left">
                    ...
                    <div>
                        <h1 className="text-2xl md:text-3xl font-bold font-TT-Commons">
                            African Group delivers value to clients by ensuring they get the right value proposition, 
                            helping them decode a complex market and delivering real estate solutions that enable 
                            them to achieve their goals.
                        </h1>
                    </div>

                    <div className="description opacity-100 font-TT-Commons">
                        From global real estate investors to specialist developers, distribution giants to biotech start-ups, African Group advises the businesses that are driving the economy, creating jobs, and harnessing innovation.<br /><br />
