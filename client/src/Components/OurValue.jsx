const OurValue = () => {
    return(
        <section className="accordion-block bg-[#eef1f5] py-[3.75rem] md:py-[6.5625rem] font-TT-Commons">
            <div className="flex flex-col md:flex-row gap-4 md:gap-8 px-[0.625rem] md:px-[1.5625rem] lg:px-[3.125rem] font-TT-Commons">
                ...
                <div className=" font-TT-Commons">
                    <div className="font-TT-Commons border-t-[0.0625rem] border-solid border-[rgba(0,0,0,0.2)]">
                        <div
